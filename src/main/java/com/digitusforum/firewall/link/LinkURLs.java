...
public class LinkURLs {
	public static String LINK = EnvironmentService.TRAINING_SERVER_URL + EnvironmentService.TRAINING_SERVER_PORT
			+ "/link" + EnvironmentService.TRAINING_SERVER_VERSION;
